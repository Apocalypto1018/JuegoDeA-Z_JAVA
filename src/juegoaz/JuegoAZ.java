...
public class JuegoAZ {
    ...
    public static void jugar(){
        ...
        //al confirmar el registro, se pasan los valores a la lista
        ...
        //una ves validado la opcion de orden de turno, se asigna para jugar
        if(orden=='s'){
    ...
    //funcion que elige el orden inicial de turno (genera un numero al azar entre 0 y 2 excluyendo al 2)
